...
Spritesheet::Spritesheet(const std::string & texture_filename, SpritesheetMorphology type) {
    ...
    */
    *this = Spritesheet(texture_filename, type, rows, cols);
}

Spritesheet::Spritesheet(const std::string & texture_filename, SpritesheetMorphology type, int rows, int cols) {
    ...
    *this = Spritesheet(texture_filename, type, rows, cols, sprite_width, sprite_height);
}

Spritesheet::Spritesheet(const std::string & texture_filename, SpritesheetMorphology type, int rows, int cols, int sprite_width, int sprite_height) :
    m_sprite_type(type),
    m_rows(rows),
    m_cols(cols),
